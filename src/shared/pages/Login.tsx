...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-[#141414] flex items-center justify-center p-4 sm:p-6 font-sans">
      <motion.div 
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
        className="w-full max-w-md bg-white border border-[#141414] shadow-[8px_8px_0px_0px_rgba(255,255,255,0.1)] p-6 sm:p-8"
      >
